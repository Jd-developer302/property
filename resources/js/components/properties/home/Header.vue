        ...
        <div class="container po-relative">
          <nav class="navbar navbar-expand-lg header-nav-bar justify-content-between">
            ...
            <div class="act-buttons d-flex">
              <a href="/fr/" class="laung" :style="{ color: laungColor }" title="French">
                <img :src="frenchImage" width="30" height="30" alt="French" class="img-fluid">
                <span>French</span>
              </a>
              <a href="/es/" class="laung" :style="{ color: laungColor }" title="Spanish">
                <img :src="spanishImage" width="30" height="30" alt="Spanish" class="img-fluid">
                <span>Spanish</span>
              </a>
              <a href="/cn/" class="laung" :style="{ color: laungColor }" title="Chinese">
                <img :src="chineseImage" width="30" height="30" alt="Chinese" class="img-fluid">
                <span>Chinese</span>
              </a>
              <a href="/ru/" class="laung" :style="{ color: laungColor }" title="Russian">
                <img :src="russianImage" width="30" height="30" alt="Russian" class="img-fluid">
                <span>Russian</span>
              </a>
              <a id="whatsappenId" target="_blank" class="login p-1 pr-2 whatsapp" :style="{ color: whatsappColor }" href="#">
...
<template>
  <div>
    <!-- Topbar with sticky functionality -->
    <div class="topbar" :class="{ 'scrolled': isScrolled }">
      <div class="header exchange-logo">
        <div class="container po-relative">
          <nav class="navbar navbar-expand-lg header-nav-bar justify-content-between" >
            <div class="navbar-brand d-flex">
              <!-- Icons with dynamic color based on scroll -->
              <a href="#" :style="{ color: facebookColor }"><i class="fa-brands fa-facebook-f"></i></a>
              <a href="#" :style="{ color: instagramColor }"><i class="fa-brands fa-instagram"></i></a>
              <a href="#" :style="{ color: linkedinColor }"><i class="fa-brands fa-linkedin-in"></i></a>
              <a href="#" :style="{ color: youtubeColor }"><i class="fa-brands fa-youtube"></i></a>
      ...
      <div class="side-inner">
        <div class="nav-menu">
          <ul>
            ...
            <li><a href="#"><span class="fa-solid fa-right-to-bracket mr-3 icon_side_menu"></span>Location</a></li>
            <li><a href="#"><span class="fa-solid fa-right-to-bracket mr-3 icon_side_menu"></span>Foreign Investors</a></li>
            <li><a href="#"><span class="fa-solid fa-right-to-bracket mr-3 icon_side_menu"></span>Investment Offers</a></li>
            <li><a href="#"><span class="fa-solid fa-right-to-bracket mr-3 icon_side_menu"></span>News & Articles</a></li>
...
export default {
  ...
  setup() {
    ...
    const toggleColor = computed(() => isScrolled.value ? '#9C3133' : '#fff');
    const whatsappColor = computed(() => isScrolled.value ? '#25D366' : '#fff');
    const laungColor = computed(() => isScrolled.value ? '#9C3133' : '#fff');
